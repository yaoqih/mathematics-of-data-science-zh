...
$$\begin{equation}
\label{gordontail}
\inf_{x\in S} \| {\mathcal A}(Z) \| \geq \sqrt{m-1} - \omega(S) - t, \qquad \text{for $t > 0$,}
\end{equation}$$
...
::: lemma
[]{#le:candesrechtlowrank label="le:candesrechtlowrank"} 设 $X_0\in\R^{n_1\times n_2}$ 满足 $\mathcal A(X_0)=y\in\R^m$，并假设：
